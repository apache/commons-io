 ...
 * @since 1.4
 */
public class NameFileComparator extends AbstractIFileComparator implements Serializable {

    private static final long serialVersionUID = 8397947749814525798L;

    /** Case-sensitive name comparator instance (see {@link IOCase#SENSITIVE}) */
    public static final Comparator<IFile> NAME_COMPARATOR = new NameFileComparator();

    /** Case-insensitive name comparator instance (see {@link IOCase#INSENSITIVE}) */
    public static final Comparator<IFile> NAME_INSENSITIVE_COMPARATOR = new NameFileComparator(IOCase.INSENSITIVE);


    /** System sensitive name comparator instance (see {@link IOCase#SYSTEM}) */
    public static final Comparator<IFile> NAME_SYSTEM_COMPARATOR = new NameFileComparator(IOCase.SYSTEM);
