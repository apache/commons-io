...
public class LineEndUnifiedBufferedReaderTest {
    ...
    public void testClose() throws Exception {
        LineEndUnifiedBufferedReader b = new LineEndUnifiedBufferedReader(null);
        closeSeveralTimes(b);
        LineEndUnifiedBufferedReader b2 =
    ...
    public void testFullRead() throws Exception {
        LineEndUnifiedBufferedReader b =
     ...
     * @see org.apache.commons.io.IOUtilsTestCase#testContentEqualsIgnoreEOL()
     */
